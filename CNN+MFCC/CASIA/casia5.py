...
# Load file list
mylist = os.listdir('D:\Third year project\Dataset\Casia2/')
...
for index, y in enumerate(mylist):
    if mylist[index][0:1] in ['A', 'F', 'S', 'H','N']:
        # Load
        X, sample_rate = librosa.load('D:\\Third year project\\Dataset\\Casia2\\' + y, res_type='kaiser_fast', duration=2.5, sr=22050, offset=0.5)
        # Extract MFCCs
...
# Split
X_train, X_temp, y_train, y_temp = train_test_split(features, labels, test_size=6/50, random_state=42, stratify=labels)
