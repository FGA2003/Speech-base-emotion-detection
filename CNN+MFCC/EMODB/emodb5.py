...
# Load file list
mylist = os.listdir('D:\Third year project\Dataset\emodb3/')
...
for index, y in enumerate(mylist):
    if mylist[index][0:1] in ['N', 'F', 'T', 'W','A']:
        # Load
        X, sample_rate = librosa.load(os.path.join('D:\\Third year project\\Dataset\\emodb3', y), res_type='kaiser_fast', duration=2.5, sr=22050, offset=0.5)
        # Extract MFCCs
